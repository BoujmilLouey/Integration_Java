...
public class ShowAllController implements Initializable {
    ...
    @FXML
    private void ajouterLigne_commande(ActionEvent event) throws IOException {
          AnchorPane root = FXMLLoader.load(getClass().getResource("/com/xemacscode/gui/back/ligne_commande/Manage.fxml"));
